export default () => {
    ...
    const plan = {
        name: "Free Credits",
        desc: "Get started with 20 free credits when you create an account. Generate 4 images per credit.",
        price: 0,
        features: [
            "Generate 4 images per credit",
    ...
    const features = [
        {
            name: "Scalable",
            desc: "Our platform scales effortlessly to meet your growing needs, ensuring seamless performance at all times.",
            icon:
        ...
        {
            name: "Flexible",
            desc: "Enjoy the flexibility to generate images at any time, with a credit system that adapts to your usage patterns.",
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        {
            name: "Smooth",
            desc: "Experience smooth and efficient image generation with our state-of-the-art AI technology.",
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        {
            name: "Secure",
            desc: "Your data is secure with us. We ensure top-notch security measures to protect your information.",
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <div className="max-w-screen-xl mx-auto text-gray-600 md:px-8">
                <div className='relative max-w-xl space-y-3 px-4 md:px-0'>
                    ...
                    <div className='max-w-xl'>
                        <p>
                            Start with 20 free credits. Generate high-quality images and only pay for what you use. Each credit allows you to generate 4 images.
                        </p>
                    </div>
                </div>
                        ...
                        <div className="p-4 py-8 border-b md:p-8">
                            <div className="justify-between flex">
                                ...
                                <div className='flex-none text-gray-800 text-2xl font-semibold sm:text-3xl'>
                                    ${plan.price} <span className="text-xl text-gray-600 font-normal"></span>
                                </div>
                            </div>
                            <a href="app">
