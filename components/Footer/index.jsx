...
export default () => {
    ...
    return (
        <footer className="dark:text-white dark:bg-neutral-800 bg-neutral-200 px-4 py-5 max-w-screen-xl mx-auto md:px-8">
            <div className="gap-6 justify-between md:flex">
                <div className="flex-1">
                    <div className="max-w-xs">
                        {/* <img  src="https://img.freepik.com/free-vector/head-with-ai-chip_78370-3672.jpg" className="w-10" /> */}
                        <p className="leading-relaxed mt-2 text-[15px]">
                            Genie Genesis allows you to transform text descriptions into stunning images using our state-of-the-art diffusion model.
                        </p>
                    </div>
                    <form
                    ...
                    >
                        ...
                        <div className="max-w-sm flex gap-2 items-center border dark:border-neutral-500 rounded-md p-1">
                            <input
                                type="email"
                                placeholder="Enter your email"
                                className="w-full p-2.5 outline-none dark:text-white dark:bg-neutral-700"
            ...
            <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; {new Date().getFullYear()} Genie Genesis. All rights reserved.
                </div>
