...
const InputPrompt = ({
    ...
    const fuse = useMemo(
        () =>
            new Fuse(isInpenting ? promptListInpenting[selectedProject] : promptList[selectedProject], {
        ...
        <section>
            <div
                className={`border px-2 mx-2 py-1 dark:bg-neutral-800 bg-gray-200 shadow-md rounded-md overflow-hidden ${
                    openSections.includes("prompt") ? "border-gray-500" : "dark:border-gray-600 border-gray-400"
            ...
            <div
                className={`border mt-3 ${
                    ...
                    openSections.includes('negativePrompt')
                        ? 'border-gray-500' : 'dark:border-gray-600 border-gray-400'
                } transition-all duration-300`}
            >
                <label
