...
// import { IoMdPhotos } from "react-icons/io"; // New icon for Image Blending
...
//                 <FaBraille className="" />
//               )}
//               {isInpenting ? "Inpainting" : isImageBlending ? "Image Blending" : "Gen AI"}
//             </Link>
//           </div>
...
//           className="space-y-4 overflow-x-hidden   relative"
//         >
...
//                   </>
//                 )}
//                 <span className="ml-3 font-semibold">Upload Image {isImageBlending ? "1" : ""}</span>
//               </div>
...
//           {/* Second image upload for Image Blending */}
//           {isImageBlending && (
//             <div
//               className={`relative border-y px-4 py-2 text-sm transition-transform duration-300 ease-in-out ${
...
//                     </>
//                   )}
//                   <span className="ml-3 font-semibold">Upload Image 2</span>
//                 </div>
//                 <div className="text-gray-500">
//                   {openSections.includes("uploadImage2") ? (
//                     <MdExpandLess size={12} />
...
//                   {/* <div
//                     className={`relative border-y px-4 -mx-4 py-2 text-sm transition-transform duration-300 ease-in-out ${
//                       openSections.includes("selectProject")
//                         ? "dark:border-gray-500 border-gray-500"
//                         : "dark:border-gray-600 border-gray-400"
//                     } transform-gpu hover:scale-100 dark:hover:border-gray-600 hover:border-gray-600`}
...
//                     <div
//                       className="flex items-center justify-between cursor-pointer dark:hover:text-neutral-500 hover:text-indigo-500"
//                       onClick={() => toggleSection("allClasses")}
//                     >
//                       <div className="flex items-center">
//                         {openSections.includes("allClasses") ? (
//                           <>
...
//                           </>
//                         )}
//                         <span className="ml-3 font-semibold">All Classes</span>
//                       </div>
//                       <div className="text-gray-500">
//                         {openSections.includes("allClasses") ? (
//                           <MdExpandLess size={12} />
...
//                           "ehacm",
//                           "material foam",
//                           "schlieren with crease",
//                         ].map((label, index) => (
//                           <span
//                             key={index}
//                             onClick={() => setInputPrompt(label)} // 🔥 Click to set the prompt
//                             className="px-4 py-2 text-xs font-semibold rounded-full shadow-md cursor-pointer transition-all duration-300
//           bg-gradient-to-r from-indigo-400 to-purple-500 text-white
//           dark:from-neutral-700 dark:to-neutral-900 dark:text-neutral-200
//           hover:scale-105 hover:shadow-xl hover:from-indigo-500 hover:to-purple-600
//           dark:hover:from-neutral-600 dark:hover:to-neutral-800
//           active:scale-95 active:shadow-sm" // 🔥 Click animation
//                           >
//                             {label}
//                           </span>
//                         ))}
...
import { AiOutlineCloudUpload, AiOutlineProject } from "react-icons/ai";
import { FaSeedling, FaBraille, FaImages } from "react-icons/fa";
import { MdExpandLess, MdExpandMore, MdGrain, MdOutlineAddAPhoto, MdOutlineMergeType, MdOutlineNoPhotography } from "react-icons/md";
import { Step, Eye, EyeSlash, Strength } from "../Icons";
import { TbBoxMultiple, TbVariable } from "react-icons/tb";
import axios from "axios";
import { GiArtificialHive, GiFountainPen, GiRegeneration, GiResize } from "react-icons/gi";
import { TbPointerCheck } from "react-icons/tb";
