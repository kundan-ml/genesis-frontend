...
import TrainginBody from '@/components/Anomaly/Training/TrainginBody';
import TrainingStatus from '@/components/Anomaly/Training/TrainginBody/training-status/page';
import TrainingHistory from '@/components/Anomaly/Training/TrainingHistory';
import ModelDetailsPage from '@/components/common/ModelDetailsPage';
...
const anomalyTraining = () => {
  ...
  const [modeldetails, setModelsDetails] = useState([])
  const [datasetsData, setDatasetsData] = useState([])
  const [trainingSubmition, setTrainingSubmition] = useState([])
  ...
  return (
    <section>
      ...
      <TrainingHistory
        ...
        setModelsDetails={setModelsDetails}
        setDatasetsData={setDatasetsData}
        setTrainingSubmition={setTrainingSubmition}
      ...
      {showModel && (
        ...
        username={username}
        trainingSubmition={trainingSubmition}
        />
      )
